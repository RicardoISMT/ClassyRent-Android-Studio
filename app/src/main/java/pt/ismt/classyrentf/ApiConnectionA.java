...
public class ApiConnectionA extends AsyncTask<String, Void, Void> {
    ...
    protected void onPreExecute() {
        ...
        _pdialog = new ProgressDialog(_activityA);
                ...
                try {
                    ...
                    if (_resposta.get("dados") instanceof JSONArray) {
                        ...
                        for (int i = 0; i < _listAlunosJson.length(); i++) {
                            JSONObject _place = _listAlunosJson.getJSONObject(i);
                            ...
                            String descricao = _place.getString("descricao");
                            ...
                            place.put("descricao", String.valueOf(descricao));
    ...
    protected void onPostExecute(Void _resultado) {
        ...
        if (_activityA.getClass().getSimpleName().equals("MainActivity")) {
            MainActivity ma = (MainActivity) _activityA;
            ma.updateUI();

        } else if (_activityA.getClass().getSimpleName().equals("InsertAloActivity")) {
            InsertAloActivity ia = (InsertAloActivity) _activityA;
            ia.successMessage();
